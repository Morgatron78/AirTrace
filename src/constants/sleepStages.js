...
// Apple Health integration — see docs/apple-health-integration.md.
...
// small visual marker (Sleep stages legend/AHI-by-stage rows on Night
// View, the event popover's "Sleep stage" row, Trends' Sleep architecture
// breakdown rows). Deliberately icon-shape-distinct rather than relying
// on color alone: a stage marker sitting right next to a scored-event
// marker (own color palette, red/orange/blue) in the same popover would
// otherwise compete for the same visual channel. Sun/Moon (Awake/Core)
// pair naturally; Eye/Waves (REM/Deep) are literal (rapid eye movement;
// slow-wave sleep).
