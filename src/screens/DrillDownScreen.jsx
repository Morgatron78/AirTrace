  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
      ...
      {expandedChart && (() => {
        ...
        return (
          <div style={{ position: 'fixed', inset: 0, background: T.bg, zIndex: 50, padding: 'max(20px, calc(env(safe-area-inset-top, 0px) + 16px)) max(16px, env(safe-area-inset-right, 0px)) max(20px, env(safe-area-inset-bottom, 0px)) max(16px, env(safe-area-inset-left, 0px))', display: 'flex', flexDirection: 'column' }}>
